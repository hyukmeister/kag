...
<div class="jumbotron" style="width: 800px;">
    ...
    <div class="jumbotron" style="width: 800px;">
        ...
        <asp:Table ID="tblI485_ATRPR1" runat="server" class="table table-hover" Width="100%">
            ...
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <asp:DropDownList ID="ddlCountryOfBirth" runat="server" Style="border-radius: 8px;" AutoPostBack="true">
                    </asp:DropDownList><br />
                </asp:TableCell>
                <asp:TableCell>
                    <br />
                    <asp:Label class="form-label" runat="server" ID="labCitizenship" HorizontalAlign="Left">Country of Citizenship</asp:Label><br />
                    <asp:DropDownList ID="ddlCitizenship" runat="server" Style="border-radius: 8px;" AutoPostBack="true">
                    </asp:DropDownList><br />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <asp:DropDownList ID="ddlCountryOfMil" runat="server" Style="border-radius: 8px;" AutoPostBack="true"></asp:DropDownList><br />
                </asp:TableCell>
                <asp:TableCell>
                    <br />
                    <div class="form-floating mb-3;">
                ...
                <asp:TableCell ColumnSpan="4">
                    ...
                    <label for="floatingInputGrid">
                        Have you ever applied for an immigrant visa to obtain permanent resident status at a U.S. Embassy
                            <br />or U.S. Consulate abroad? </label>
                    <br />
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    ...
                    <asp:DropDownList ID="ddlCountryOfConsulate" runat="server" Style="border-radius: 8px;" AutoPostBack="true">
                    </asp:DropDownList><br />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
        ...
        <br />
        <h3>
            <asp:Label ID="labMainApplicantInfo" runat="server" Text="Documentation (Mandatory)"></asp:Label></h3>
        <asp:Table ID="I485_ATRPR4" runat="server" class="table table-hover" Width="100%">
            <asp:TableRow>
                <asp:TableCell ColumnSpan="3">
                        <br />
        ...
        <br />
        <h3>
            <asp:Label ID="labBackgroundInfo1" runat="server" Text="Your Background Information (Yes/No Questions)"></asp:Label></h3>
        <asp:Label ID="labBackgroundInfo2" runat="server" Text="<b>==>If you answer &quot;Yes,&quot; please describe the details (When, Where, Why, How, final outcome, etc.)</b>"></asp:Label>
            <asp:Table ID="I485_ATRPR5" runat="server" class="table table-hover" Width="100%">
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="3">
                        <br />
