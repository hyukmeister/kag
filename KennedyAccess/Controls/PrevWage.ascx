...
<asp:Table ID="tabMain" runat="server" Width="100%" class="table table-hover">
    <asp:TableRow>
        <asp:TableCell ColumnSpan="4">
            <div class="form-floating mb-3;">
                <asp:TextBox ID="txtJobTitle" class="form-control" runat="server" placeholder="Job Title" ReadOnly="true" BorderStyle="None" Width="100%"></asp:TextBox>
    ...
    <asp:TableRow>
        <asp:TableCell ColumnSpan="4">
            <div class="form-floating mb-3;">
                <asp:TextBox ID="txtJobDuties" class="form-control" runat="server" placeholder="Job Duties" ReadOnly="true" BorderStyle="None" Width="100%" Rows="5" TextMode="MultiLine"></asp:TextBox>
    ...
    <asp:TableRow>
        <asp:TableCell ColumnSpan="2" Style="width: 350px">
            <div class="form-floating mb-3;" style="width: 350px">
                <asp:TextBox ID="txtWageTrackingNum" class="form-control" runat="server" placeholder="Wage Tracking Number" ReadOnly="true" BorderStyle="None" Width="350px"></asp:TextBox>
        ...
        <asp:TableCell ColumnSpan="2" Style="width: 350px">
            <div class="form-floating mb-3;" style="width: 350px">
                <asp:TextBox ID="txtSOCOESCode" class="form-control" runat="server" placeholder="SOCOES Code" ReadOnly="true" BorderStyle="None" Width="350px"></asp:TextBox>
    ...
    <asp:TableRow>
        <asp:TableCell ColumnSpan="2" Style="width: 350px">
            <div class="form-floating mb-3;" style="width: 350px">
                <asp:TextBox ID="txtOccupationTitle" class="form-control" runat="server" placeholder="Occupation Title" ReadOnly="true" BorderStyle="None" Width="350px"></asp:TextBox>
        ...
        <asp:TableCell ColumnSpan="2" Style="width: 350px">
            <div class="form-floating mb-3;" style="width: 350px">
                <asp:TextBox ID="txtSkillLevel" class="form-control" runat="server" placeholder="Skill Level" ReadOnly="true" BorderStyle="None" Width="350px"></asp:TextBox>
    ...
    <asp:TableRow>
        <asp:TableCell ColumnSpan="4">
            <div class="form-floating mb-3;">
                <asp:TextBox ID="txtPrevailingWage" class="form-control" runat="server" placeholder="Prevailing Wage" ReadOnly="true" BorderStyle="None" TextMode="Number" step="0.01"></asp:TextBox>
            ...
            <asp:RadioButtonList ID="rblRatePeriod" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" Enabled="false" BorderStyle="None">
    ...
    <asp:TableRow>
        <asp:TableCell ColumnSpan="4">
           ...
           <br />
            <asp:RadioButtonList ID="rblWageSource" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" Enabled="false" BorderStyle="None">
    ...
    <asp:TableRow>
        <asp:TableCell ColumnSpan="4">
            <div class="form-floating mb-3;">
                <asp:TextBox ID="txtSource" class="form-control" runat="server" placeholder="If Other is indicated, specify" ReadOnly="true" BorderStyle="None" Width="100%"></asp:TextBox>
    ...
    <asp:TableRow>
        <asp:TableCell ColumnSpan="2" Style="width: 350px">
            <div class="form-floating mb-3;" style="width: 350px">
                <asp:TextBox ID="txtDateDetermined" class="form-control" runat="server" placeholder="Date Determined" ReadOnly="true" BorderStyle="None" TextMode="Date" Width="350px"></asp:TextBox>
        ...
        <asp:TableCell ColumnSpan="2" Style="width: 350px">
            <div class="form-floating mb-3;" style="width: 350px">
                <asp:TextBox ID="txtDateExpiration" class="form-control" runat="server" placeholder="Expiration Date" ReadOnly="true" BorderStyle="None" TextMode="Date" Width="350px"></asp:TextBox>
        ...
        <asp:TableCell ColumnSpan="4">
            <div class="form-floating mb-3;">
                <asp:TextBox ID="txtI_5_AdditionalRecruitment" class="form-control" runat="server" placeholder="Specify additional recruitment information in this space. Add an attachment if necessary."
                    ReadOnly="true" BorderStyle="None" Width="100%" Rows="5" TextMode="MultiLine"></asp:TextBox>
