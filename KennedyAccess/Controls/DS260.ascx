            ...
            <asp:Table ID="tblDS260_VEA" runat="server" class="table table-hover" Width="100%">
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        ...
                        <asp:DropDownList ID="ddl8_CountryOfBirth" runat="server" Style="border-radius: 8px;" AutoPostBack="true">
                        </asp:DropDownList><br />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell>
                        ...
                        <asp:DropDownList ID="ddl9_Nationality" runat="server" Style="border-radius: 8px;" AutoPostBack="true">
                        </asp:DropDownList><br />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        ...
                        <asp:DropDownList ID="ddl10_1_CountryPPIssued" runat="server" Style="border-radius: 8px;" AutoPostBack="true">
                        </asp:DropDownList><br />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
