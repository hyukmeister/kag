<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="I140SubmissionCkList.aspx.cs" Inherits="KennedyAccess.I140SubmissionCkList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>I-140 Submission Checklist</h2>
    ...
    <asp:Table ID="tabI140SubmissionCKList" runat="server" class="table table-hover">
        <asp:TableRow BackColor="dimgray" CssClass="rounded-corners">
            <asp:TableCell ColumnSpan="2">
                <label class="form-label" HorizontalAlign="Left" style="font-size:22px; color:white;">I-140 Submission Check List</label>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
        ...
        <asp:TableRow>
            <asp:TableCell>
                <asp:Label runat="server" Text="Date of Request"></asp:Label>
            </asp:TableCell>
            <asp:TableCell>
                <div class="form-floating mb-3;">
