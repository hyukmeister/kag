        ...
        <asp:Table ID="tabCampaigns" runat="server" BorderStyle="None" Width="100%">
            ...
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" BorderStyle="None">
                    <asp:GridView ID="gvCampaigns" runat="server" AutoGenerateColumns="False" GridLines="None" 
                        ShowFooter="true" CellPadding="4" OnRowCommand="gvCampaign_RowCommand" EmptyDataText="No Campaign found" 
                        class="table table-hover rounded-corners" AllowSorting="True" OnSorting="gvCampaigns_Sorting">
                        <Columns>
